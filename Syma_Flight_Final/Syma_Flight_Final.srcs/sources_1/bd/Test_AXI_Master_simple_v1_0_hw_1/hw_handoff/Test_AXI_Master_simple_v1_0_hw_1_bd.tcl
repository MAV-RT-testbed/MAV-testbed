...
################################################################
# This is a generated script based on design: Test_AXI_Master_simple_v1_0_hw_1
#
...
# source Test_AXI_Master_simple_v1_0_hw_1_script.tcl
...
set design_name Test_AXI_Master_simple_v1_0_hw_1
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set mosi_o [ create_bd_port -dir O mosi_o ]
  set ppm_signal_in [ create_bd_port -dir I ppm_signal_in ]
  set sck_o [ create_bd_port -dir O sck_o ]
  set ss_o [ create_bd_port -dir O -from 0 -to 0 ss_o ]

  # Create instance: Syma_Ctrl, and set properties
  set Syma_Ctrl [ create_bd_cell -type ip -vlnv rcs.ei.tum.de:user:Syma_Ctrl_core:1.2 Syma_Ctrl ]
  set_property -dict [ list CONFIG.C_M01_AXI_TARGET_SLAVE_BASE_ADDR {0x44A00000} CONFIG.C_M01_AXI_TRANSACTIONS_NUM {1} CONFIG.DEBUG {0}  ] $Syma_Ctrl

  # Create instance: axi_interconnect_general, and set properties
  set axi_interconnect_general [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_interconnect_general ]
  set_property -dict [ list CONFIG.NUM_MI {3}  ] $axi_interconnect_general

  # Create instance: axi_interconnect_spi, and set properties
  set axi_interconnect_spi [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_interconnect_spi ]
  set_property -dict [ list CONFIG.NUM_MI {1} CONFIG.NUM_SI {2}  ] $axi_interconnect_spi
  ...
  set_property -dict [ list CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {7.3728} CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {24} CONFIG.CLKOUT2_USED {true} CONFIG.USE_LOCKED {false} CONFIG.USE_RESET {false}  ] $clk_wiz
  ...
  set_property -dict [ list CONFIG.NUM_PORTS {3}  ] $concat_irq

  # Create instance: jtag_axi_0, and set properties
  set jtag_axi_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:jtag_axi:1.0 jtag_axi_0 ]
  set_property -dict [ list CONFIG.PROTOCOL {0}  ] $jtag_axi_0
...
CONFIG.PCW_UIPARAM_DDR_DRAM_WIDTH {16 Bits} CONFIG.PCW_UIPARAM_DDR_PARTNO {MT41K256M16 RE-125} \
...
CONFIG.PCW_USB0_PERIPHERAL_ENABLE {0} CONFIG.PCW_USB0_PERIPHERAL_FREQMHZ {60} \
CONFIG.PCW_USB0_RESET_ENABLE {0} CONFIG.PCW_USB0_RESET_IO {<Select>} \
CONFIG.PCW_USB0_USB0_IO {<Select>} CONFIG.PCW_USE_FABRIC_INTERRUPT {1} \
...
CONFIG.preset {Default*}  ] $processing_system7_0
  ...
  set_property -dict [ list CONFIG.C_OPERATION {xor} CONFIG.C_SIZE {1}  ] $util_vector_logic_0

  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_interconnect_spi/S00_AXI] [get_bd_intf_pins jtag_axi_0/M_AXI]
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_pins Syma_Ctrl/M01_AXI] [get_bd_intf_pins axi_interconnect_spi/S01_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_general_M00_AXI [get_bd_intf_pins Syma_Ctrl/S00_AXI] [get_bd_intf_pins axi_interconnect_general/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_general_M01_AXI [get_bd_intf_pins Syma_Ctrl/S01_AXI] [get_bd_intf_pins axi_interconnect_general/M01_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_general_M02_AXI [get_bd_intf_pins axi_interconnect_general/M02_AXI] [get_bd_intf_pins axi_timer_0/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_spi_M00_AXI [get_bd_intf_pins axi_interconnect_spi/M00_AXI] [get_bd_intf_pins axi_quad_spi_0/AXI_LITE]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins axi_interconnect_general/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]

  # Create port connections
  connect_bd_net -net Syma_Ctrl_l_ss_init [get_bd_pins Syma_Ctrl/l_ss_init] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net Syma_Ctrl_ppm_irq_complete [get_bd_pins Syma_Ctrl/ppm_irq_complete] [get_bd_pins concat_irq/In1]
  connect_bd_net -net Syma_Ctrl_ppm_irq_single [get_bd_pins Syma_Ctrl/ppm_irq_single] [get_bd_pins concat_irq/In0]
  connect_bd_net -net axi_quad_spi_0_io0_o [get_bd_ports mosi_o] [get_bd_pins axi_quad_spi_0/io0_o]
  connect_bd_net -net axi_quad_spi_0_sck_o [get_bd_ports sck_o] [get_bd_pins axi_quad_spi_0/sck_o]
  connect_bd_net -net axi_quad_spi_0_ss_o [get_bd_pins axi_quad_spi_0/ss_o] [get_bd_pins util_vector_logic_0/Op2]
  connect_bd_net -net axi_timer_0_interrupt [get_bd_pins axi_timer_0/interrupt] [get_bd_pins concat_irq/In2]
  connect_bd_net -net clk_wiz_clk_out1 [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins clk_wiz/clk_out1]
  connect_bd_net -net clk_wiz_clk_out2 [get_bd_pins Syma_Ctrl/sample_clk] [get_bd_pins clk_wiz/clk_out2]
  connect_bd_net -net concat_irq_dout [get_bd_pins concat_irq/dout] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net ppm_signal_in_1 [get_bd_ports ppm_signal_in] [get_bd_pins Syma_Ctrl/ppm_signal_in]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Syma_Ctrl/m01_axi_aclk] [get_bd_pins Syma_Ctrl/s00_axi_aclk] [get_bd_pins Syma_Ctrl/s01_axi_aclk] [get_bd_pins axi_interconnect_general/ACLK] [get_bd_pins axi_interconnect_general/M00_ACLK] [get_bd_pins axi_interconnect_general/M01_ACLK] [get_bd_pins axi_interconnect_general/M02_ACLK] [get_bd_pins axi_interconnect_general/S00_ACLK] [get_bd_pins axi_interconnect_spi/ACLK] [get_bd_pins axi_interconnect_spi/M00_ACLK] [get_bd_pins axi_interconnect_spi/S00_ACLK] [get_bd_pins axi_interconnect_spi/S01_ACLK] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins clk_wiz/clk_in1] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins sys_reset_0/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins sys_reset_0/ext_reset_in]
  connect_bd_net -net sys_reset_0_peripheral_aresetn [get_bd_pins Syma_Ctrl/m01_axi_aresetn] [get_bd_pins Syma_Ctrl/s00_axi_aresetn] [get_bd_pins Syma_Ctrl/s01_axi_aresetn] [get_bd_pins axi_interconnect_general/ARESETN] [get_bd_pins axi_interconnect_general/M00_ARESETN] [get_bd_pins axi_interconnect_general/M01_ARESETN] [get_bd_pins axi_interconnect_general/M02_ARESETN] [get_bd_pins axi_interconnect_general/S00_ARESETN] [get_bd_pins axi_interconnect_spi/ARESETN] [get_bd_pins axi_interconnect_spi/M00_ARESETN] [get_bd_pins axi_interconnect_spi/S00_ARESETN] [get_bd_pins axi_interconnect_spi/S01_ARESETN] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_ports ss_o] [get_bd_pins util_vector_logic_0/Res]

  # Create address segments
  create_bd_addr_seg -range 0x10000 -offset 0x44A00000 [get_bd_addr_spaces Syma_Ctrl/M01_AXI] [get_bd_addr_segs axi_quad_spi_0/AXI_LITE/Reg] SEG_axi_quad_spi_0_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x44A00000 [get_bd_addr_spaces jtag_axi_0/Data] [get_bd_addr_segs axi_quad_spi_0/AXI_LITE/Reg] SEG_axi_quad_spi_0_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Syma_Ctrl/S00_AXI/S00_AXI_reg] SEG_Syma_Ctrl_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Syma_Ctrl/S01_AXI/S01_AXI_reg] SEG_Syma_Ctrl_S01_AXI_reg
