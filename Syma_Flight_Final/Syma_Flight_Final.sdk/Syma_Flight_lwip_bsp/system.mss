 ...
 PARAMETER NAME = /DIST/home/asoehn/Syma_Flight_Final/Syma_Flight_Final.sdk/Syma_Flight_bsp/system.mss
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = syma_ctrl_core
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Syma_Ctrl
END
...
BEGIN LIBRARY
 ...
 PARAMETER arp_table_size = 1
 PARAMETER ip_frag = 0
 PARAMETER ip_reass_max_pbufs = 1
 ...
 PARAMETER memp_n_tcp_seg = 0
 PARAMETER memp_num_netbuf = 2
 PARAMETER memp_num_tcpip_msg = 0
 PARAMETER tcp_maxrtx = 1
 PARAMETER tcp_mss = 1
 PARAMETER tcp_queue_ooseq = 0
 PARAMETER tcp_snd_buf = 1
 PARAMETER tcp_ttl = 1
 PARAMETER tcp_wnd = 1
END
