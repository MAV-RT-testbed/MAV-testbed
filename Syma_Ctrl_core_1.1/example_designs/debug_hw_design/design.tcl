...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: Syma_Ctrl_core_0, and set properties
	set Syma_Ctrl_core_0 [ create_bd_cell -type ip -vlnv rcs.ei.tum.de:user:Syma_Ctrl_core:1.1 Syma_Ctrl_core_0 ]
	...
	set_property -dict [ list CONFIG.NUM_MI {7} ] $axi_peri_interconnect
	...
	connect_bd_net [get_bd_pins axi_peri_interconnect/M06_ACLK] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axi_peri_interconnect/M06_ARESETN] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	# Connect all clock & reset of Syma_Ctrl_core_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins Syma_Ctrl_core_0/S00_AXI]
	connect_bd_net [get_bd_pins Syma_Ctrl_core_0/s00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins Syma_Ctrl_core_0/s00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins Syma_Ctrl_core_0/S01_AXI]
	connect_bd_net [get_bd_pins Syma_Ctrl_core_0/s01_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins Syma_Ctrl_core_0/s01_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M02_AXI] [get_bd_intf_pins Syma_Ctrl_core_0/S_AXI_INTR]
	connect_bd_net [get_bd_pins Syma_Ctrl_core_0/s_axi_intr_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins Syma_Ctrl_core_0/s_axi_intr_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of Syma_Ctrl_core_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins Syma_Ctrl_core_0/M01_AXI]
	connect_bd_net [get_bd_pins Syma_Ctrl_core_0/m01_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins Syma_Ctrl_core_0/m01_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins Syma_Ctrl_core_0/m01_axi_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins Syma_Ctrl_core_0/m01_axi_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins Syma_Ctrl_core_0/m01_axi_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]
	...
	connect_bd_intf_net [get_bd_intf_pins axi_gpio_irq/S_AXI] [get_bd_intf_pins axi_peri_interconnect/M06_AXI]
	connect_bd_net [get_bd_pins Syma_Ctrl_core_0/irq] [get_bd_pins axi_gpio_irq/gpio_io_i]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of Syma_Ctrl_core_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {Syma_Ctrl_core_0/M01_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M01_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells Syma_Ctrl_core_0]

	# Copy all address to Syma_Ctrl_core_v1_1_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/Syma_Ctrl_core_v1_1_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_Syma_Ctrl_core_0_S00_AXI_* ]]
	puts $fp "set s00_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_Syma_Ctrl_core_0_S01_AXI_* ]]
	puts $fp "set s01_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_Syma_Ctrl_core_0_S_AXI_INTR_* ]]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores rcs.ei.tum.de:user:Syma_Ctrl_core:1.1]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/Syma_Ctrl_core_v1_1_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "Syma_Ctrl_core_v1_1_hw_${i}"
